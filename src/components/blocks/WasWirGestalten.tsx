...
function CardGraphic({ name }: { name: IconKey }) {
  ...
  if (name === 'druck') {
    return (
      <svg viewBox="0 0 325 300" fill="none" xmlns="http://www.w3.org/2000/svg" className={cls} aria-hidden>
        <path opacity="0.3" d="M291 22H34V264H291V22Z" stroke="#FFED00" strokeWidth="1.5" strokeDasharray="7 5" />
        <path opacity="0.55" d="M279 34H46V252H279V34Z" stroke="#FFED00" strokeWidth="2" />
        <path d="M46 8V32" stroke="#FFED00" strokeWidth="2" />
        <path d="M20 34H44" stroke="#FFED00" strokeWidth="2" />
        <path d="M279 8V32" stroke="#FFED00" strokeWidth="2" />
        <path d="M305 34H281" stroke="#FFED00" strokeWidth="2" />
        <path d="M46 278V254" stroke="#FFED00" strokeWidth="2" />
        <path d="M20 252H44" stroke="#FFED00" strokeWidth="2" />
        <path d="M279 278V254" stroke="#FFED00" strokeWidth="2" />
        <path d="M305 252H281" stroke="#FFED00" strokeWidth="2" />
        <path
