        ...
        <svg viewBox="0 0 325 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-auto w-full">
          <g opacity="0.3">
            <path
              ...
              strokeWidth="2.5"
            />
            <path d="M54 115.2L70.8 124L54 132.8V115.2Z" fill="#FFED00" />
            <path
          ...
          <g opacity="0.3">
            <path
              ...
              strokeWidth="2.5"
            />
            <path d="M261 115.2L277.8 124L261 132.8V115.2Z" fill="#FFED00" />
            <path
          ...
          <path
            ...
            strokeWidth="2"
          />
          <path d="M153 104L174 115L153 126V104Z" fill="#FFED00" />
          <path
    ...
    <div className={wrap} aria-hidden>
      <svg viewBox="0 0 325 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-auto w-full">
        <path
          ...
          strokeWidth="2"
        />
        <path opacity="0.3" d="M6 66H319" stroke="#FFED00" strokeWidth="2" />
        <path
          opacity="0.55"
          ...
          {list.map((item) => (
            ...
            >
              ...
              <div className="flex min-w-0 flex-col gap-2.5">
                ...
                {item.text ? (
                  <p className="font-poppins text-[clamp(0.875rem,4.5cqi,1rem)] font-normal leading-[1.5] text-[#B8B8B8]">
                    {item.text}
                  </p>
                ) : null}
              </div>
