    ...
    return (
      <svg viewBox="0 0 325 300" fill="none" xmlns="http://www.w3.org/2000/svg" className={cls} aria-hidden>
        <g clipPath="url(#clip0_bekleben_fahrzeug)">
          ...
          />
          <path opacity="0.55" d="M72 138L106 94H142V134L72 138Z" fill="#FFED00" />
          <path
            ...
            fill="#FFED00"
          />
          <path opacity="0.3" d="M160 86V208" stroke="#FFED00" strokeWidth="1.5" />
          <path
          ...
          <path
            ...
            strokeWidth="2.5"
          />
          <path opacity="0.3" d="M0 234H325" stroke="#FFED00" strokeWidth="2" strokeDasharray="14 10" />
          <path
            opacity="0.3"
    ...
    return (
      <svg viewBox="0 0 325 300" fill="none" xmlns="http://www.w3.org/2000/svg" className={cls} aria-hidden>
        <g clipPath="url(#clip0_bekleben_schaufenster)">
          <path opacity="0.55" d="M10 52H315L296 22H29L10 52Z" fill="#FFED00" />
          <path
            ...
            strokeWidth="2.5"
          />
          <path opacity="0.3" d="M163 62V230" stroke="#FFED00" strokeWidth="1.5" />
          <path
          ...
          <path
            ...
            fill="#FFED00"
          />
          <path opacity="0.3" d="M299 230H26V240H299V230Z" fill="#FFED00" />
          <path opacity="0.3" d="M0 252H325" stroke="#FFED00" strokeWidth="2" />
          <path
            opacity="0.3"
    ...
    return (
      <svg viewBox="0 0 325 300" fill="none" xmlns="http://www.w3.org/2000/svg" className={cls} aria-hidden>
        <g clipPath="url(#clip0_bekleben_schilder)">
          <path opacity="0.3" d="M30 250V46H240V250" stroke="#FFED00" strokeWidth="2.5" />
          <path
            opacity="0.3"
          ...
          <path
            ...
            strokeWidth="1.5"
          />
          <path opacity="0.55" d="M240 96H272" stroke="#FFED00" strokeWidth="3" />
          <path
          ...
          <path
            ...
            fill="#FFED00"
          />
          <path opacity="0.3" d="M0 250H325" stroke="#FFED00" strokeWidth="2" />
          <path
            opacity="0.3"
    ...
    <svg viewBox="0 0 325 300" fill="none" xmlns="http://www.w3.org/2000/svg" className={cls} aria-hidden>
      <g clipPath="url(#clip0_bekleben_bauzaun)">
        <path
          ...
          strokeWidth="2"
        />
        <path opacity="0.3" d="M62 220V242" stroke="#FFED00" strokeWidth="2" />
        <path
          opacity="0.3"
        ...
        <path
          ...
          strokeWidth="2"
        />
        <path opacity="0.3" d="M162 220V242" stroke="#FFED00" strokeWidth="2" />
        <path
          opacity="0.3"
        ...
        <path
          ...
          strokeWidth="2"
        />
        <path opacity="0.3" d="M262 220V242" stroke="#FFED00" strokeWidth="2" />
        <path
          opacity="0.3"
            ...
            {list.map((item) => (
              ...
              >
                ...
                <div className="flex min-w-0 flex-col gap-2">
                  ...
                  {item.text ? (
                    <p className="font-poppins text-[clamp(0.75rem,5.5cqi,1rem)] font-normal leading-[1.5] text-[#B8B8B8]">
                      {item.text}
                    </p>
                  ) : null}
                </div>
